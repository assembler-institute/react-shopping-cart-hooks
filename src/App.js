...
function App(props) {
	...
	return (
		<BrowserRouter>
			<Route path="/" exact render={(routeProps) => <Home {...routeProps} fullWidth cartItems={cartItems} products={products} isLoading={isLoading} hasError={hasError} loadingError={loadingError} handleDownVote={handleDownVote} handleUpVote={handleUpVote} handleSetFavorite={handleSetFavorite} handleAddToCart={handleAddToCart} handleRemove={handleRemove} handleChange={handleChange} />} />
			<Route path="/new-product" exact render={(routeProps) => <NewProduct {...routeProps} saveNewProduct={saveNewProduct} />} />
		</BrowserRouter>
	);
}
